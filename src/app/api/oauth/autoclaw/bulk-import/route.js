...
import { getAutoClawBulkImportManager, parseAutoClawBulkAccounts } from "@/lib/oauth/services/autoclawBulkImportManager";
...
export async function POST(request) {
  try {
    ...
    const { parsed, invalidLines } = parseAutoClawBulkAccounts(accounts);
